...
import {
  ...
  createMill, createRail, createWaterPump, createTSF,
} from "./buildings.js";
...
export const CATALOG: BuildingSpec[] = [
  ...
  // inbound supply chain — the plant starves without these
  { type: "mill", label: "Mill (tailings)", icon: "⚙", cost: 20_000_000, fw: 20, fd: 14, markerY: 11, needsPower: true, opexPerDay: 60_000, supplies: "tailings", make: createMill },
  { type: "rail", label: "Rail terminal (binder)", icon: "🚆", cost: 10_000_000, fw: 24, fd: 8, markerY: 14, needsPower: true, opexPerDay: 25_000, supplies: "binder", make: createRail },
  { type: "waterpump", label: "Water pump", icon: "💧", cost: 6_000_000, fw: 11, fd: 11, markerY: 6, needsPower: true, opexPerDay: 15_000, supplies: "water", make: createWaterPump },
  { type: "tsf", label: "Tailings dam (TSF)", icon: "⛰", cost: 15_000_000, fw: 42, fd: 42, markerY: 7, needsPower: false, opexPerDay: 22_000, tsfCap: 260_000, make: createTSF },
];
