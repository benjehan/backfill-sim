...
export const CATALOG: BuildingSpec[] = [
  ...
  { type: "rail", label: "Rail terminal (binder)", icon: "🚆", cost: 10_000_000, fw: 24, fd: 8, markerY: 14, needsPower: true, opexPerDay: 25_000, supplies: "binder", offPad: true, upgrade: { stat: "binder", max: 2, cost0: 5_000_000, step: 0.5 }, make: createRail },
